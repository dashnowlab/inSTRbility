...
class NBGeomGlobalParams:
    ...
    def calibrate_from_results(
        cls,
        results_tsv: str,
        base_params: "NBGeomGlobalParams",
        min_reads: int = 20,
        ...
        Returns
        -------
        NBGeomGlobalParams with adjusted q_e and q_c.

        Usage
        -----
        # Run once on your initial results, then rerun analysis with new params
        gp_initial = NBGeomGlobalParams.from_defaults(motif_length=3)
        results    = analyse_genome_wide(catalog, gp_initial, ...)
        write_tsv(results, 'initial_results.tsv')

        gp_calibrated = NBGeomGlobalParams.calibrate_from_results(
...
def fit_locus_r1(
    ...
    @param re_grid, rc_grid: optional custom grids for r_e, r_c
...
def auto_fit(
    ...
    **kwargs,
    ...
    result = fit_locus_r1(
        lengths_fit, founder_length, nbgeom_params,
        haplotype_label=haplotype_label,
        mitotic_generations=mitotic_generations,
        seed=seed, **kwargs
    )
